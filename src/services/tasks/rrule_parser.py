...
class RRuleParser:
    ...
    def validate_rrule(self, rrule_string: str) -> ValidationResult:
        ...
        try:
            ...
            test_occurrences = list(rule.between(
                datetime.now(),
    ...
    def generate_occurrences(
        ...
        try:
            ...
            logger.debug(f"Generated {len(occurrences)} occurrences for rule '{rrule_string}' between {start_date} and {end_date}")
            return occurrences
