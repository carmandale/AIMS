...
class DrawdownService:
    ...
    def calculate_current_drawdown(self, snapshots: List[PerformanceSnapshot]) -> Dict[str, Any]:
        ...
        return {
            ...
            "days_in_drawdown": (current_date - peak_date).days if peak_date and drawdown_amount > 0 else 0
        }
            ...
            if value >= current_peak:
                ...
                if in_drawdown and max_drawdown_in_event >= threshold_percent:
                    ...
                    events.append({
                        ...
                        "total_days": (snapshot.snapshot_date - current_peak_date).days if is_recovered else None
                    })
    ...
    def calculate_underwater_curve(self, snapshots: List[PerformanceSnapshot]) -> List[Dict[str, Any]]:
        """
