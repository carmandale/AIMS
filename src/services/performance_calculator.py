...
class PerformanceCalculator:
    ...
    async def calculate_performance_metrics(
        ...
        periodic_returns = self._calculate_periodic_returns(portfolio_values, timeframe)
    ...
    async def calculate_risk_metrics(
        ...
        # Calculate maximum drawdown
        max_drawdown = self._calculate_max_drawdown(portfolio_values)
        max_drawdown_start, max_drawdown_end = self._get_max_drawdown_period(portfolio_values)
    ...
    async def compare_to_benchmark(
        ...
        benchmark_data = {
            "SPY": {"daily": 0.05, "weekly": 0.12, "monthly": 0.45, "ytd": 8.5, "all": 10.2},
            "QQQ": {"daily": 0.08, "weekly": 0.18, "monthly": 0.65, "ytd": 12.3, "all": 15.8},
        }
    ...
    async def _get_portfolio_values(
        ...
        for i in range(days_diff + 1):
            ...
            portfolio_values.append(
                {"date": date, "value": max(value, Decimal("1000"))}  # Minimum value
            )
    ...
    def _calculate_periodic_returns(
        ...
        if timeframe in ["weekly", "monthly", "ytd", "all"]:
            ...
            if weekly_returns:
                ...
                returns["weekly_std"] = (
                    statistics.stdev(weekly_returns) if len(weekly_returns) > 1 else 0
                )
