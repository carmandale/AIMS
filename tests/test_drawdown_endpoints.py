...
class TestDrawdownAPIEndpoints:
    ...
    def test_get_current_drawdown_success(self, client: TestClient, auth_headers: dict, performance_snapshots: list):
    ...
    def test_get_historical_drawdowns_success(self, client: TestClient, auth_headers: dict, performance_snapshots: list):
    ...
    def test_get_historical_drawdowns_with_dates(self, client: TestClient, auth_headers: dict, performance_snapshots: list):
    ...
    def test_get_drawdown_analysis_success(self, client: TestClient, auth_headers: dict, performance_snapshots: list):
    ...
    def test_get_drawdown_alerts_success(self, client: TestClient, auth_headers: dict, performance_snapshots: list):
