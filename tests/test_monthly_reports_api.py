...
class TestMonthlyReportsAPI:
    ...
    def test_generate_monthly_report_success(
        ...
        with patch(
            "src.services.monthly_report_service.MonthlyReportService.generate_monthly_report"
        ) as mock_generate:
    ...
    def test_monthly_report_generation_with_no_data(self, client: TestClient, auth_headers: dict):
