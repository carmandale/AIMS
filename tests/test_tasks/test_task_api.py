...
class TestTaskAPI:
    ...
    def test_skip_task(self):
        ...
        response = self.client.post("/api/tasks/1/skip", json={"reason": "Not applicable today"})
    ...
    def test_update_task_status(self):
        ...
        response = self.client.put("/api/tasks/1/status", json={"status": "in_progress"})
    ...
    def test_update_task_invalid_status(self):
        ...
        response = self.client.put("/api/tasks/1/status", json={"status": "invalid_status"})
