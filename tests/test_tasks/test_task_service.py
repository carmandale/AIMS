...
class TestTaskService:
    ...
    def test_create_task_template_invalid_rrule(self):
        ...
        with pytest.raises(ValueError, match="Invalid RRULE"):
            self.service.create_task_template(
                self.mock_db,
                name="Test Task",
                rrule="INVALID_RRULE"
            )
    ...
    def test_generate_task_instances(self):
        ...
        mock_occurrences = [
            datetime(2025, 7, 16, 10, 0),
            datetime(2025, 7, 17, 10, 0)
        ]
    ...
    def test_get_overdue_tasks(self):
        ...
        mock_tasks = [
            self._create_mock_task(1, "Overdue Task", "pending")
        ]
    ...
    def test_get_compliance_metrics(self):
        ...
        self.service.compliance_checker.check_blocking_tasks_complete.return_value.all_complete = False
