...
class TestDrawdownService:
    ...
    def test_calculate_underwater_curve(self, drawdown_service, sample_snapshots):
        ...
        assert abs(curve[6]["drawdown_percent"] - Decimal("12.38")) < Decimal("0.01")  # Max drawdown
    ...
    def test_check_alert_thresholds(self, drawdown_service, sample_snapshots):
        ...
        alerts = drawdown_service.check_alert_thresholds(
            ...
            critical_threshold=Decimal("15.0")
        )
    ...
    def test_check_alert_thresholds_critical(self, drawdown_service):
        ...
        snapshots = [
            PerformanceSnapshot(
                ...
                daily_pnl=Decimal("0"), daily_pnl_percent=Decimal("0"),
                weekly_pnl=Decimal("0"), weekly_pnl_percent=Decimal("0"),
                monthly_pnl=Decimal("0"), monthly_pnl_percent=Decimal("0"),
                ytd_pnl=Decimal("0"), ytd_pnl_percent=Decimal("0"),
                volatility=Decimal("15.0"), sharpe_ratio=Decimal("1.2"),
                max_drawdown=Decimal("0"), created_at=datetime.utcnow()
            ),
            PerformanceSnapshot(
                id=2, user_id=1,
