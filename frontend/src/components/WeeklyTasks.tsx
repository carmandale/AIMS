...
export const WeeklyTasks: React.FC = () => {
  ...
  const [tasks, setTasks] = useState<Task[]>([
    {
      id: '1',
      name: 'Review portfolio performance',
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-gray-900 rounded-2xl p-6 shadow-2xl border border-gray-800">
      {/* Header */}
