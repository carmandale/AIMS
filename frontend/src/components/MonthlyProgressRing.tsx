    ...
    <div className="relative">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          >
            <p className="text-3xl font-bold text-white mb-1">${currentIncome.toLocaleString()}</p>
            <p className="text-slate-400 text-sm mb-2">of ${monthlyGoal.toLocaleString()}</p>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      {showTooltip && (
        <Tooltip
          content={`Daily average needed: $${Math.round(dailyAverageNeeded)}`}
