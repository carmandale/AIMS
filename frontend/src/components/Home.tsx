  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-5xl font-bold text-white mb-4">AIMS</h1>
          <p className="text-xl text-slate-400">AI Investment Management System</p>
        </motion.header>
        ...
        >
          <p>Connected to backend API • Real-time data updates</p>
        </motion.footer>
      </div>
    </div>
  );
