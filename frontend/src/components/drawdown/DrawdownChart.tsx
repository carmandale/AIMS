		...
		>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
				<div className="flex items-center space-x-2">
					...
					<span className="text-slate-400">Portfolio Value: Tracks total portfolio worth over time</span>
				</div>
				<div className="flex items-center space-x-2">
				...
				<div className="flex items-center space-x-2">
					...
					<span className="text-slate-400">Underwater Curve: Cumulative drawdown visualization</span>
				</div>
			</div>
