  ...
  return <div className="space-y-6">
      ...
      delay: 0.4
        ...
        <div className="space-y-4">
          {holdings.map((holding, index) => <motion.div key={holding.symbol} initial={{
          opacity: 0,
          x: 20
        }} animate={{
          opacity: 1,
      ...
      delay: 0.5
        ...
        <div className="h-48 mb-4">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={allocationData} cx="50%" cy="50%" innerRadius={40} outerRadius={80} paddingAngle={2} dataKey="value">
        ...
        <div className="space-y-2">
          {allocationData.map((item, index) => <div key={index} className="flex items-center justify-between">
