...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
  ...
  if (isLoading) {
    return (
      <div
        className={cn(
          'min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100',
          className
        )}
      >
        <motion.div
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-slate-900 mb-2">Verifying access...</h2>
  ...
  if (requireAuth && !isAuthenticated) {
    ...
    return (
      <div
        className={cn(
          'min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 p-4',
          className
        )}
      >
        <motion.div
