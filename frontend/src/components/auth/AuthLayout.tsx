...
const AuthLayout: React.FC<AuthLayoutProps> = ({ className, onAuthSuccess }) => {
  ...
  return (
    <div
      className={cn(
        'min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black p-4',
        className
      )}
    >
      <motion.div
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    'placeholder:text-gray-500 bg-gray-700/50 text-white',
                    errors.email
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <button
                ...
                className="ml-1 text-blue-400 font-medium hover:text-blue-300 transition-all duration-200"
              >
