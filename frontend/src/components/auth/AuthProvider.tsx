...
export const AuthProvider: React.FC<AuthProviderProps> = ({
        ...
        if (response.success && response.data) {
          ...
          setAuthState({
            user: {
              ...
              name: userData.email, // Use email as name since backend doesn't have name field
            },
            token: storedToken,
      ...
      if (response.success && response.data) {
        ...
        setAuthState({
          user: {
            id: user_id,
            email: email,
            name: email, // Use email as name since backend doesn't have name field
          },
          token: access_token,
          isAuthenticated: true,
          isLoading: false
  ...
  const refreshToken = async (): Promise<void> => {
    try {
      ...
      // If successful, token is still valid - no action needed
    } catch (error) {
      console.error('Token refresh failed:', error);
      logout();
    }
