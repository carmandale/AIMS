...
test.describe('Phase 2 Widget Integration', () => {
  ...
  test('should render HoldingsTable widget', async ({ page }) => {
    ...
    const holdingsElements = page.locator('[data-testid*="holdings"], [class*="holdings"], [class*="Holdings"]');
  ...
  test('should render PerformanceChart widget', async ({ page }) => {
    ...
    const performanceElements = page.locator('[data-testid*="performance"], [class*="performance"], [class*="Performance"], [class*="chart"], [class*="Chart"]');
  ...
  test('should render NextActionsWidget', async ({ page }) => {
    ...
    const actionsElements = page.locator('[data-testid*="actions"], [class*="actions"], [class*="Actions"], [class*="next"]');
  ...
  test('should render MorningBriefCard', async ({ page }) => {
    ...
    const briefElements = page.locator('[data-testid*="brief"], [class*="brief"], [class*="Brief"], [class*="morning"], [class*="Morning"]');
  ...
  test('should check for SnapTrade integration elements', async ({ page }) => {
    ...
    const snapTradeElements = page.locator('[data-testid*="snaptrade"], [class*="snaptrade"], [class*="SnapTrade"], text="SnapTrade"');
    ...
    const accountElements = page.locator('[data-testid*="account"], [class*="account"], [class*="Account"]');
