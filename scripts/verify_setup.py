...
from scripts.utils import (
    setup_logging, get_project_root, check_python_version,
    check_node_version, find_executable, run_command,
    check_port_available, wait_for_port, load_env_file,
    print_header, print_success, print_error, print_warning,
    print_info, get_platform_info
)
...
class SetupVerifier:
    ...
    def check_database(self) -> bool:
        ...
        try:
            ...
            expected_tables = [
                "users", "positions", "transactions", "task_templates"
            ]
...
def main():
    ...
    parser.add_argument("--skip-backend", action="store_true", help="Skip backend startup if not running")
